  ...
  return (
    <button
      ...
      className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium border transition-all duration-200
        border-gray-200 text-gray-500 hover:border-[#0bbcaa] hover:text-[#0bbcaa] hover:bg-[#0bbcaa]/5"
    >
      {copied ? (
        <>
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-xl p-8 mb-6">
          <div className="flex items-start gap-6">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-sm text-gray-400">miahajaz@gmail.com</p>
              <p className="text-sm text-gray-500 mt-2">Software Engineer · Job seeker</p>
            </div>

            {/* Edit button */}
            <button className="flex-shrink-0 px-4 py-2 rounded-lg text-sm font-medium border border-gray-200 text-gray-600 hover:border-[#0bbcaa] hover:text-[#0bbcaa] hover:bg-[#0bbcaa]/5 transition-all duration-200">
              Edit profile
            </button>
          </div>
        </div>
            ...
            {MOCK_RESUMES.map((resume) => (
              ...
              >
                ...
                <div className="flex-shrink-0 w-9 h-9 rounded-lg bg-white border border-gray-200 flex items-center justify-center shadow-sm group-hover:border-[#0bbcaa]/30 transition-colors">
                  <svg className="w-4.5 h-4.5 text-[#0bbcaa]" style={{ width: "18px", height: "18px" }} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
