    ...
    <>
      {filteredApplications.map((app) => (
        ...
        >
          ...
          <div className="w-full lg:w-1/6 text-sm text-gray-700">{app.position}</div>
          <div className="w-full lg:w-1/6 text-sm text-gray-700">{app.salary}</div>
          ...
          <div className="w-full lg:w-1/6 text-sm text-gray-500 hidden md:block">
