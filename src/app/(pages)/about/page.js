...
function about() {
  ...
  return (
    <div className="px-30 bg-main text-white py-[4em]">
      <div className="pt-30">
      <Heading text={'Why We Built Resumind'} size={1} classes='text-[3em] pb-[1em]'noTrim />
      <p className="text-white text-[20px]">{aboutText}</p> <br/>

      <em className="container">--Built by someone who’s been there—applying, tailoring, and forgetting. ResumeRecall is the tool I wish I had when job hunting.</em>
